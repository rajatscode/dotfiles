# 30-git.zsh - Git shortcuts and workflow helpers
...
## ============================================================================
## Git Info Integration with vcs_info
## ============================================================================

# Enable vcs_info for git prompt integration
...
# This will be used by 50-prompt.zsh
precmd_vcs_info() {
    vcs_info
}

# Add to precmd hooks if not already present
if [[ ! "${precmd_functions[(r)precmd_vcs_info]}" == "precmd_vcs_info" ]]; then
