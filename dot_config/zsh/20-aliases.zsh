# 20-aliases.zsh - Handy-Dandy Aliases and Utility Functions

## ============================================================================
## Sudo Helpers
## ============================================================================

## sudo should support zsh aliases
alias sudo="sudo "
...
alias alert='notify-send --urgency=low -i "$([ $? = 0 ] && echo terminal || echo error)" "$(history -1 | sed -e '\''s/^\s*[0-9]\+\s*//;s/[;&|]\s*alert$//'\'')"' 2>/dev/null || true
